\chapter{Experimental Setup: The Large Hadron Collider and CMS}~\label{ch:CMSExperiment}
...
\begin{figure}[htbp!]
    % \captionsetup{justification=justified, singlelinecheck=false, position=top} % Caption setup
